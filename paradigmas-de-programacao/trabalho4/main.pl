%problema 25: https://rachacuca.com.br/logica/problemas/esquadrilha-de-avioes-ii/
%fatos
...
%X esta a ao lado de Y
aoLado(X, Y, Lista) :- nextto(X,Y,Lista); nextto(Y,X,Lista).
                       
%X esta a esquerda de Y (em qualquer posição a esquerda)
aEsquerda(X, Y ,Lista) :- nth0(IndexX, Lista, X), 
                          nth0(IndexY, Lista, Y), 
                          IndexX < IndexY.
                        
%X esta a direita de Y (em qualquer posicao a direita)
